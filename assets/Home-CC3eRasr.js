...
`;function xe({stars:a,observer:l,date:t,onStarClick:s,onStarHover:n}){const u=o.useRef(null),d=o.useRef(null),c=o.useRef(null),[r,x]=o.useState(-1),g=o.useRef(null),{gl:v,camera:w}=q(),M=o.useMemo(()=>fe(),[]),m=o.useMemo(()=>{const i=[];for(const h of a){if(h.ra===null||h.dec===null)continue;const y=oe(h.ra,h.dec,l,t,me);if(!y.visible)continue;const C=pe(h.hostname);i.push({star:h,position:new G(y.x,y.y,y.z),color:new te(ie(h.star_class)),size:re(h.sy_vmag),twinkleSpeed:.5+C%100/50,twinklePhase:C%1e3/1e3*Math.PI*2,twinkleIntensity:.15+C%50/200})}return i},[a,l,t]),p=o.useMemo(()=>{const i=m.length,h=new Float32Array(i*3),y=new Float32Array(i*3),C=new Float32Array(i),P=new Float32Array(i),N=new Float32Array(i),R=new Float32Array(i),z=new Float32Array(i);return m.forEach((k,b)=>{h[b*3]=k.position.x,h[b*3+1]=k.position.y,h[b*3+2]=k.position.z,y[b*3]=k.color.r,y[b*3+1]=k.color.g,y[b*3+2]=k.color.b,C[b]=k.size,P[b]=k.twinkleSpeed,N[b]=k.twinklePhase,R[b]=k.twinkleIntensity,z[b]=0}),{positions:h,colors:y,sizes:C,twinkleSpeeds:P,twinklePhases:N,twinkleIntensities:R,isHovered:z}},[m]),E=o.useRef(null);o.useEffect(()=>{if(!c.current)return;const i=c.current;i.setAttribute("position",new I(p.positions,3)),i.setAttribute("starColor",new I(p.colors,3)),i.setAttribute("starSize",new I(p.sizes,1)),i.setAttribute("twinkleSpeed",new I(p.twinkleSpeeds,1)),i.setAttribute("twinklePhase",new I(p.twinklePhases,1)),i.setAttribute("twinkleIntensity",new I(p.twinkleIntensities,1));const h=new I(p.isHovered,1);i.setAttribute("isHovered",h),E.current=h,i.computeBoundingSphere()},[p]),_(i=>{if(d.current&&(d.current.uniforms.uTime.value=i.clock.elapsedTime),E.current){const h=E.current.array;let y=!1;for(let C=0;C<h.length;C++){const N=(C===r?1:0)-h[C];Math.abs(N)>.001&&(h[C]+=N*.15,y=!0)}y&&(E.current.needsUpdate=!0)}});const f=o.useCallback(i=>{if(m.length===0)return;const h=v.domElement.getBoundingClientRect(),y=i.clientX-h.left,C=i.clientY-h.top;let P=-1,N=1/0;const R=15;for(let z=0;z<m.length;z++){const k=m[z],b=k.position.clone().project(w);if(b.z>1)continue;const j=(b.x+1)/2*h.width,L=(1-b.y)/2*h.height,Y=y-j,V=C-L,O=Math.sqrt(Y*Y+V*V),J=R+k.size*$*.3;O<J&&O<N&&(P=z,N=O)}P!==r?(x(P),P>=0?(v.domElement.style.cursor="pointer",n==null||n(m[P].star,{x:i.clientX,y:i.clientY})):(v.domElement.style.cursor="grab",n==null||n(null))):P>=0&&(n==null||n(m[P].star,{x:i.clientX,y:i.clientY}))},[m,r,v,w,n]),S=o.useCallback(i=>{g.current={x:i.clientX,y:i.clientY}},[]),A=o.useCallback(i=>{if(g.current){const h=i.clientX-g.current.x,y=i.clientY-g.current.y;if(Math.sqrt(h*h+y*y)>5)return}r>=0&&m[r]&&(s==null||s(m[r].star))},[r,m,s]),T=o.useCallback(()=>{x(-1),v.domElement.style.cursor="grab",n==null||n(null)},[v,n]);return o.useEffect(()=>{const i=v.domElement;return i.addEventListener("pointerdown",S),i.addEventListener("pointermove",f),i.addEventListener("click",A),i.addEventListener("pointerleave",T),()=>{i.removeEventListener("pointerdown",S),i.removeEventListener("pointermove",f),i.removeEventListener("click",A),i.removeEventListener("pointerleave",T)}},[v,S,f,A,T]),o.useEffect(()=>()=>{M.dispose()},[M]),m.length===0?null:e.jsxs("points",{ref:u,frustumCulled:!1,children:[e.jsx("bufferGeometry",{ref:c}),e.jsx("shaderMaterial",{ref:d,vertexShader:ge,fragmentShader:ve,uniforms:{uTime:{value:0},uTexture:{value:M}},transparent:!0,depthWrite:!1,blending:se})]})}function ye({longitude:a=0}){const[l,t]=o.useState(!1),[s,n]=o.useState(null),u=o.useRef(0),d=o.useRef(0),c=o.useMemo(()=>({uRotation:{value:0}}),[]);return o.useEffect(()=>{const r=()=>{try{D.isLoaded()?(n({surfaceVert:D.get("earthSurfaceVert"),surfaceFrag:D.get("earthSurfaceFrag"),atmosphereVert:D.get("atmosphereVert"),atmosphereFrag:D.get("atmosphereFrag")}),t(!0)):setTimeout(r,100)}catch(x){console.warn("Earth shaders not available, using fallback:",x),t(!0)}};r()},[]),o.useEffect(()=>{u.current=-a*Math.PI/180},[a]),_(()=>{const r=u.current-d.current;d.current+=r*.05,c.uRotation.value=d.current}),!l||!s?e.jsx("group",{children:e.jsxs("mesh",{position:[0,-600,0],children:[e.jsx("sphereGeometry",{args:[580,64,32]}),e.jsx("meshBasicMaterial",{color:8432354})]})}):e.jsxs("group",{children:[e.jsxs("mesh",{position:[0,-600,0],children:[e.jsx("sphereGeometry",{args:[580,64,64]}),e.jsx("shaderMaterial",{vertexShader:s.surfaceVert,fragmentShader:s.surfaceFrag,uniforms:c})]}),e.jsxs("mesh",{position:[0,-600,0],scale:[1.02,1.02,1.02],children:[e.jsx("sphereGeometry",{args:[580,64,64]}),e.jsx("shaderMaterial",{vertexShader:s.atmosphereVert,fragmentShader:s.atmosphereFrag,transparent:!0,side:X,depthWrite:!1})]})]})}const W=5e3,Se=12e3,be=3,we=20,Ce=.8,F=80,je=15,B=[{name:"ISS",color:"#ffffff",size:1,panels:!0},{name:"Satellite",color:"#aaaaaa",size:.6,panels:!0},{name:"Debris",color:"#666666",size:.3,panels:!1}];function Me({satellite:a,onExpired:l}){const t=o.useRef(null),s=o.useRef(a.createdAt);_(u=>{if(!t.current)return;const d=u.clock.elapsedTime-s.current;if(d>we){l(a.id);return}const c=d*a.speed,r=a.startPosition.clone().add(a.direction.clone().multiplyScalar(c));t.current.position.copy(r),t.current.rotation.x+=.01,t.current.rotation.y+=.02});const n=Ce*a.type.size;return e.jsxs("group",{ref:t,position:a.startPosition,children:[e.jsxs("mesh",{children:[e.jsx("boxGeometry",{args:[n,n*.5,n*.5]}),e.jsx("meshBasicMaterial",{color:a.type.color})]}),a.type.panels&&e.jsxs(e.Fragment,{children:[e.jsxs("mesh",{position:[n*.8,0,0],children:[e.jsx("boxGeometry",{args:[n*.8,n*.05,n*.4]}),e.jsx("meshBasicMaterial",{color:"#1a3a5c"})]}),e.jsxs("mesh",{position:[-n*.8,0,0],children:[e.jsx("boxGeometry",{args:[n*.8,n*.05,n*.4]}),e.jsx("meshBasicMaterial",{color:"#1a3a5c"})]})]})]})}function Ee(){const[a,l]=o.useState([]),t=o.useRef(0),s=o.useRef(null);_(u=>{s.current||(s.current=u.clock)}),o.useEffect(()=>{const u=()=>{s.current&&l(r=>{var T;if(r.length>=be)return r;const x=Math.random()>.5,g=x?-F:F,v=10+Math.random()*40,w=-F*(.3+Math.random()*.7),M=x?1:-1,m=(Math.random()-.5)*.3,p=(Math.random()-.5)*.5,E=new G(M,m,p).normalize(),f=Math.random(),S=f<.15?B[0]:f<.7?B[1]:B[2],A={id:t.current++,type:S,startPosition:new G(g,v,w),direction:E,speed:je*(.8+Math.random()*.4),createdAt:((T=s.current)==null?void 0:T.elapsedTime)??0,altitude:F};return[...r,A]})},d=()=>{const r=W+Math.random()*(Se-W);return setTimeout(()=>{u(),c=d()},r)};let c=setTimeout(()=>{u(),c=d()},3e3);return()=>clearTimeout(c)},[]);const n=u=>{l(d=>d.filter(c=>c.id!==u))};return e.jsx("group",{children:a.map(u=>e.jsx(Me,{satellite:u,onExpired:n},u.id))})}function Z(a){return a<.5?4*a*a*a:1-Math.pow(-2*a+2,3)/2}function Ae(a){const t=2.5949095;return a<.5?Math.pow(2*a,2)*((t+1)*2*a-t)/2:(Math.pow(2*a-2,2)*((t+1)*(a*2-2)+t)+2)/2}const Te=`
...
`;function Le({progress:a}){const l=o.useRef(null),t=o.useMemo(()=>({uTime:{value:0},uOpacity:{value:1}}),[]);if(_((d,c)=>{l.current&&(l.current.rotation.y+=c*.15),t.uTime.value=d.clock.elapsedTime}),a>=1)return null;const s=580,n=.35*(1-a),u=-600-a*500;return e.jsxs("group",{ref:l,position:[0,0,u],scale:[n,n,n],children:[e.jsxs("mesh",{children:[e.jsx("sphereGeometry",{args:[s,64,64]}),e.jsx("shaderMaterial",{vertexShader:Te,fragmentShader:ke,uniforms:t,transparent:!0})]}),e.jsxs("mesh",{scale:[1.05,1.05,1.05],children:[e.jsx("sphereGeometry",{args:[s,32,32]}),e.jsx("meshBasicMaterial",{color:4491519,transparent:!0,opacity:.15,side:X})]}),e.jsxs("mesh",{scale:[1.12,1.12,1.12],children:[e.jsx("sphereGeometry",{args:[s,32,32]}),e.jsx("meshBasicMaterial",{color:6728447,transparent:!0,opacity:.08,side:X})]})]})}function Pe({introState:a,onBearingChange:l,controlsEnabled:t}){const{camera:s,gl:n}=q(),u=o.useRef(!1),d=o.useRef({x:0,y:0}),c=o.useRef({azimuth:180,altitude:10});return _(()=>{const{phase:r}=a;if(r==="earth-spin"||r==="camera-swoop")s.position.set(0,0,0),s.lookAt(0,0,-100),s.updateProjectionMatrix();else if((r==="stars-fade"||r==="complete")&&!t){s.position.set(0,0,0);const x=c.current.azimuth*Math.PI/180,g=c.current.altitude*Math.PI/180;s.lookAt(-Math.sin(x)*Math.cos(g)*100,Math.sin(g)*100,-Math.cos(x)*Math.cos(g)*100),s.updateProjectionMatrix()}}),o.useEffect(()=>{if(!t)return;const r=n.domElement,x=()=>{const{azimuth:f,altitude:S}=c.current,A=f*Math.PI/180,T=S*Math.PI/180;s.position.set(0,0,0),s.lookAt(-Math.sin(A)*Math.cos(T)*100,Math.sin(T)*100,-Math.cos(A)*Math.cos(T)*100),s.updateProjectionMatrix(),l(f,S)},g=f=>{u.current=!0,d.current={x:f.clientX,y:f.clientY},r.style.cursor="grabbing"},v=()=>{u.current=!1,r.style.cursor="grab"},w=f=>{if(!u.current)return;const S=f.clientX-d.current.x,A=f.clientY-d.current.y;c.current.azimuth-=S*.3,c.current.altitude+=A*.3,c.current.azimuth=(c.current.azimuth%360+360)%360,c.current.altitude=Math.max(-10,Math.min(90,c.current.altitude)),d.current={x:f.clientX,y:f.clientY},x()},M=()=>{u.current=!1,r.style.cursor="grab"},m=f=>{if(f.touches.length!==1)return;u.current=!0;const S=f.touches[0];d.current={x:S.clientX,y:S.clientY}},p=()=>{u.current=!1},E=f=>{if(!u.current||f.touches.length!==1)return;f.preventDefault();const S=f.touches[0],A=S.clientX-d.current.x,T=S.clientY-d.current.y;c.current.azimuth-=A*.3,c.current.altitude+=T*.3,c.current.azimuth=(c.current.azimuth%360+360)%360,c.current.altitude=Math.max(-10,Math.min(90,c.current.altitude)),d.current={x:S.clientX,y:S.clientY},x()};return r.style.cursor="grab",r.addEventListener("mousedown",g),r.addEventListener("mouseup",v),r.addEventListener("mousemove",w),r.addEventListener("mouseleave",M),r.addEventListener("touchstart",m),r.addEventListener("touchend",p),r.addEventListener("touchmove",E,{passive:!1}),x(),()=>{r.removeEventListener("mousedown",g),r.removeEventListener("mouseup",v),r.removeEventListener("mousemove",w),r.removeEventListener("mouseleave",M),r.removeEventListener("touchstart",m),r.removeEventListener("touchend",p),r.removeEventListener("touchmove",E)}},[n,s,t,l]),null}function Ne({opacity:a}){const t=o.useMemo(()=>{const s=new Float32Array(9e3);for(let n=0;n<3e3;n++){const u=Math.random()*Math.PI*2,d=Math.acos(2*Math.random()-1),c=800;s[n*3]=c*Math.sin(d)*Math.cos(u),s[n*3+1]=c*Math.sin(d)*Math.sin(u),s[n*3+2]=c*Math.cos(d)}return s},[]);return e.jsxs("points",{children:[e.jsx("bufferGeometry",{children:e.jsx("bufferAttribute",{attach:"attributes-position",count:3e3,array:t,itemSize:3})}),e.jsx("pointsMaterial",{size:.8,color:8947848,transparent:!0,opacity:a*.5,sizeAttenuation:!1})]})}function ze(){const[a,l]=o.useState({phase:"earth-spin",progress:0}),t=o.useRef(Date.now()),s=5e3,n=2500,u=2e3,d=o.useCallback(()=>{l({phase:"complete",progress:1})},[]);o.useEffect(()=>{let g;const v=()=>{const w=Date.now(),M=w-t.current;l(m=>{if(m.phase==="complete")return m;if(m.phase==="earth-spin"){const p=Math.min(M/s,1);return p>=1?(t.current=w,{phase:"camera-swoop",progress:0}):{...m,progress:p}}if(m.phase==="camera-swoop"){const p=Math.min(M/n,1);return p>=1?(t.current=w,{phase:"stars-fade",progress:0}):{...m,progress:p}}if(m.phase==="stars-fade"){const p=Math.min(M/u,1);return p>=1?{phase:"complete",progress:1}:{...m,progress:p}}return m}),a.phase!=="complete"&&(g=requestAnimationFrame(v))};return g=requestAnimationFrame(v),()=>cancelAnimationFrame(g)},[a.phase]);const c=a.phase==="stars-fade"?Z(a.progress):a.phase==="complete"?1:0,r=a.phase==="camera-swoop"?Ae(a.progress):a.phase==="stars-fade"||a.phase==="complete"?1:0,x=a.phase==="complete";return{state:a,introEarthExitProgress:r,starsOpacity:c,controlsEnabled:x,skipIntro:d}}function Ie(a){const[l,t]=o.useState(a),[s,n]=o.useState(a),[u,d]=o.useState(!1),c=o.useRef(Date.now()),r=o.useRef(a),x=2e3;o.useEffect(()=>{if(!u)return;let v;const w=()=>{const M=Date.now()-c.current,m=Math.min(M/x,1),p=Z(m),E=r.current.latitude+(s.latitude-r.current.latitude)*p,f=r.current.longitude+(s.longitude-r.current.longitude)*p;t({latitude:E,longitude:f}),m<1?v=requestAnimationFrame(w):(d(!1),t(s))};return v=requestAnimationFrame(w),()=>cancelAnimationFrame(v)},[u,s]);const g=o.useCallback(v=>{r.current=l,c.current=Date.now(),n(v),d(!0)},[l]);return{currentLocation:l,changeLocation:g,isAnimating:u}}function Re({starCount:a,planetCount:l,onDismiss:t,isExiting:s}){const{t:n}=K();return e.jsx("div",{className:`welcome-card-container ${s?"exiting":""}`,children:e.jsxs("div",{className:"welcome-card",children:[e.jsx("h2",{className:"welcome-title",children:n("pages.home.infoCard.title")}),e.jsx("p",{className:"welcome-description",children:n("pages.home.infoCard.description")}),e.jsx("div",{className:"welcome-stats",children:n("pages.home.infoCard.stats",{starCount:a.toLocaleString(),planetCount:l.toLocaleString()})}),e.jsx("p",{className:"welcome-hint",children:n("pages.home.infoCard.hint")}),e.jsx("button",{className:"welcome-dismiss",onClick:t,children:n("pages.home.infoCard.dismiss")})]})})}function _e({stars:a,onStarClick:l}){const{currentLocation:t,changeLocation:s,isAnimating:n}=Ie(U["São Paulo"]),[u]=o.useState(()=>new Date),[d,c]=o.useState({azimuth:180,altitude:-10}),[r,x]=o.useState(!1),[g,v]=o.useState(null),[w,M]=o.useState(null),[m,p]=o.useState("São Paulo"),[E,f]=o.useState(!1),[S,A]=o.useState(!1),T=o.useRef(!1),{state:i,introEarthExitProgress:h,starsOpacity:y,controlsEnabled:C,skipIntro:P}=ze();o.useEffect(()=>{if(i.phase==="complete"&&!T.current&&!E){const j=setTimeout(()=>{f(!0)},300);return()=>clearTimeout(j)}},[i.phase,E]);const N=o.useCallback(()=>{T.current=!0,A(!0),setTimeout(()=>{f(!1),A(!1)},300)},[]),R=o.useCallback((j,L)=>{c({azimuth:j,altitude:L})},[]),z=o.useCallback((j,L)=>{s(L),p(j),x(!1)},[s]),k=o.useCallback((j,L)=>{v(j),M(L??null)},[]),b=i.phase==="complete";return e.jsxs("div",{className:"starfield-container",children:[e.jsxs(ne,{camera:{fov:60,near:.1,far:2e3,position:[0,50,400]},gl:{antialias:!0,alpha:!1},style:{background:"#000"},children:[e.jsx("color",{attach:"background",args:["#000000"]}),e.jsx(Pe,{introState:i,onBearingChange:R,controlsEnabled:C}),e.jsx("ambientLight",{intensity:.3}),e.jsx(Le,{progress:h}),(i.phase==="stars-fade"||i.phase==="complete")&&e.jsxs(e.Fragment,{children:[e.jsx(Ne,{opacity:1}),e.jsx(xe,{stars:a,observer:t,date:u,onStarClick:l,onStarHover:k}),e.jsx(ye,{longitude:t.longitude}),i.phase==="complete"&&e.jsx(Ee,{})]})]}),(i.phase==="stars-fade"||i.phase==="complete")&&e.jsx("div",{className:"scene-fade-overlay",style:{opacity:1-y,pointerEvents:y>=1?"none":"auto"}}),b&&e.jsxs("div",{className:"starfield-bearing",children:[e.jsx("div",{className:"bearing-title",children:"Telescope Bearing"}),e.jsxs("div",{className:"bearing-value",children:[e.jsx("span",{className:"bearing-icon",children:"↔"})," ",ce(d.azimuth)]}),e.jsxs("div",{className:"bearing-value",children:[e.jsx("span",{className:"bearing-icon",children:"↕"})," ",le(d.altitude)]})]}),g&&w&&b&&e.jsxs("div",{className:"starfield-tooltip",style:{left:w.x+20,top:w.y-10},children:[e.jsx("div",{className:"tooltip-name",children:g.hostname}),e.jsxs("div",{className:"tooltip-info",children:[g.sy_pnum," planet",g.sy_pnum!==1?"s":"",g.distance_ly&&e.jsxs(e.Fragment,{children:[" · ",g.distance_ly.toFixed(1)," ly"]})]}),e.jsx("div",{className:"tooltip-hint",children:"Click to explore"})]}),b&&e.jsxs("div",{className:"starfield-location",children:[n?e.jsxs("span",{className:"location-coords location-animating",children:["Traveling to ",m,"..."]}):e.jsxs("span",{className:"location-coords",children:[m," · ",ue(t.latitude),","," ",de(t.longitude)]}),e.jsx("button",{className:"location-button",onClick:()=>x(!r),disabled:n,children:"CHANGE LOCATION"}),r&&!n&&e.jsx("div",{className:"location-picker",children:Object.entries(U).map(([j,L])=>e.jsx("button",{className:"location-option",onClick:()=>z(j,L),children:j},j))})]}),b&&e.jsx("div",{className:"starfield-info",children:e.jsxs("span",{children:[a.length.toLocaleString()," exoplanet host stars"]})}),i.phase!=="complete"&&e.jsxs("div",{className:"intro-overlay",onClick:P,children:[i.phase==="earth-spin"&&e.jsx("div",{className:"intro-text",children:e.jsx("span",{className:"intro-title",children:"EXOPLANETS".split("").map((j,L)=>e.jsx("span",{className:"intro-letter",style:{animationDelay:`${L*.3}s`},children:j},L))})}),(i.phase==="camera-swoop"||i.phase==="stars-fade")&&e.jsx("div",{className:"intro-text",style:{opacity:i.phase==="stars-fade"?1-y:1},children:e.jsx("span",{className:"intro-subtitle",children:"Explore the cosmos"})}),i.phase!=="stars-fade"&&e.jsx("div",{className:"intro-skip",children:"Click anywhere to skip"})]}),E&&e.jsx(Re,{starCount:a.length,planetCount:a.reduce((j,L)=>j+(L.sy_pnum||0),0),onDismiss:N,isExiting:S})]})}function Be(){const{getAllStars:a}=Q(),l=H(),t=a(),s=o.useCallback(n=>{l(`/stars/${ee(n.hostname)}`)},[l]);return e.jsx(_e,{stars:t,onStarClick:s})}export{Be as default};
